...
bool intersection(int path,int k) {
    ...
    F_T = (by - ay) * Tx + (ax - by) * Ty + (bx * ay - ax * by);
    F_U = (by - ay) * Ux + (ax - by) * Uy + (bx * ay - ax * by);
    F_R = (by - ay) * Rx + (ax - by) * Ry + (bx * ay - ax * by);
    F_S = (by - ay) * Sx + (ax - by) * Sy + (bx * ay - ax * by);
